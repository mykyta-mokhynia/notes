...
- **Release quality tracking:** `RELEASE_BACKLOG.md` is the single repo-level register for unfinished production work, known bugs, and technical follow-ups grouped by severity and status.
